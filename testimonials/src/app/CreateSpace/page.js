    ...
    <div className='w-[100vw]' >
        ...
        <div className=' flex flex-col w-[90vw] p-[10px] m-auto rounded-[5px] p-2 mb-2 lg:flex-row justify-center '>
            <div className='flex flex-col top-0 justify-start border p-[20px] border-dotted w-[85vw] lg:w-[35vw] mb-2 mt-3 text-center'>   
                <div className='bg-[aquamarine] rounded-[15px] border-solid border-[1px] w-[70vw] h-[30px]  lg:w-[30vw] ml-auto mr-auto'>
            ...
            <div className='flex flex-col justify-center border p-[20px] border-dotted w-[85vw] lg:w-[35vw] m-3 h-[115vh] text-center'>
                <h1 className='text-center text-3xl font-[bold] mt-1'>Create a new space</h1>
                ...
                <form className='mt-3 p-[15px] flex flex-col justify-start text-left '>
                    ...
                    <input className='border-solid border-[2px] h-[35px] w-[70vw] lg:w-[28vw] outline-none ' id= "name" type="text" />
                    ...
                    <FormGroup>
                        <FormControlLabel control={<Switch defaultChecked />} label="Name" />
                        <FormControlLabel control={<Switch />} label="Email" />
                        <FormControlLabel control={<Switch />} label="Address" />
                    </FormGroup>
                    <button type="button" className='text-center w-[70vw] h-[40px] bg-[blue] text-[white] m-2 lg:w-[30vw] '>Create new Space</button>
                </form>
            </div>
        </div>
    </div>
